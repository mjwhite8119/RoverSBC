...
#ifndef ROVER_NODE__ODOMETRY_HPP_
#define ROVER_NODE__ODOMETRY_HPP_
...
private:
  ...
  std::shared_ptr<
    message_filters::Subscriber<sensor_msgs::msg::Imu>> msg_ftr_imu_sub_;
...
#endif  // ROVER_NODE__ODOMETRY_HPP_
